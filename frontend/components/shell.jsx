// Shell — dark desktop window chrome for the poker app
...
function GoldButton({ children, onClick, variant = 'solid', size = 'md', style = {} }) {
  const sizes = {
...
Object.assign(window, { Sidebar, TopBar, GoldButton, TrafficLights });
