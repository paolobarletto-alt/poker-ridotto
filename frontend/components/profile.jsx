// Profile — user stats, history, chart
  ...
  return (
    <svg width={w} height={h} style={{ display: 'block' }}>
      ...
      <line x1={pad} x2={w-pad} y1={zeroY} y2={zeroY}
            stroke="rgba(245,241,232,0.15)" strokeDasharray="2,3" />
...
function StatTile({ label, value, sub, accent, wide }) {
  return (
    <div style={{
      ...
      <div style={{
        fontSize: 9.5, letterSpacing: '0.22em', color: 'rgba(245,241,232,0.5)',
        fontWeight: 600, marginBottom: 8, fontFamily: 'Inter, sans-serif',
      }}>{label}</div>
      <div style={{
        fontFamily: 'Playfair Display, serif', fontSize: 26, fontWeight: 500,
        color: accent ? '#D4AF37' : '#F5F1E8', letterSpacing: '-0.01em', lineHeight: 1,
      }}>{value}</div>
      {sub && (
        <div style={{
          marginTop: 6, fontSize: 11, color: 'rgba(245,241,232,0.55)',
    ...
    <div style={{ paddingBottom: 40 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 22, alignItems: 'center' }}>
          ...
          <div>
            ...
            <div style={{
              fontFamily: 'Playfair Display, serif', fontSize: 32, color: '#F5F1E8',
              fontWeight: 500, letterSpacing: '-0.015em', lineHeight: 1,
            }}>{USER.name}</div>
      ...
      <div style={{
        ...
        <div style={{ padding: '26px 32px', borderRight: '1px solid rgba(212,175,55,0.08)' }}>
          <div style={{ fontSize: 10, letterSpacing: '0.22em', color: 'rgba(245,241,232,0.5)', marginBottom: 8 }}>
            SALDO
          </div>
          <div style={{
            fontFamily: 'Playfair Display, serif', fontSize: 38, color: '#F5F1E8',
            fontWeight: 500, letterSpacing: '-0.02em', lineHeight: 1, marginBottom: 4,
          }}>
          ...
          <div style={{ marginTop: 22, fontSize: 10, letterSpacing: '0.22em', color: 'rgba(245,241,232,0.5)', marginBottom: 8 }}>
            RISULTATO NETTO
          </div>
          <div style={{
            fontFamily: 'Playfair Display, serif', fontSize: 28, color: '#D4AF37',
        ...
        <div style={{ padding: '26px 32px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 12 }}>
            <div>
              <div style={{ fontSize: 10, letterSpacing: '0.22em', color: '#D4AF37', marginBottom: 4 }}>
                ANDAMENTO
              </div>
              <div style={{ fontFamily: 'Playfair Display, serif', fontSize: 20, color: '#F5F1E8' }}>
                Ultimi 50 giorni
              </div>
            </div>
      ...
      <div style={{ padding: '26px 32px', borderBottom: '1px solid rgba(212,175,55,0.08)' }}>
        <div style={{ fontSize: 10, letterSpacing: '0.22em', color: '#D4AF37', marginBottom: 14 }}>
      ...
      <div style={{ padding: '26px 32px 0' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 14 }}>
          <div>
            <div style={{ fontSize: 10, letterSpacing: '0.22em', color: '#D4AF37', marginBottom: 6 }}>
              STORICO PARTITE
            </div>
...
Object.assign(window, { Profile, USER });
